        ...
        <main>
            ...
            <div class="tabelcrud">
                <form method="post">
                    ...
                    <input type="text" name="kode_kriteria" placeholder="Kode Kriteria....">
...
if (isset($_POST["simpan"])) {
    ...
    $koneksi->query("INSERT INTO kriteria (kode_kriteria, nama_kriteria, atribut_kriteria, bobot_kriteria)
    VALUES('$kode_kriteria','$nama_kriteria', '$atribut_kriteria','$bobot_kriteria') ");
